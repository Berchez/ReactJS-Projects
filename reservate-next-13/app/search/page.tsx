export default function Search() {
  return (
    <main className="bg-gray-100 main-h-screen w-screen">
        ...
        <div className="flex py-4 m-auto w-2/3 justify-between items-start">
          ...
          <div className="w-1/5">
            ...
            <div className="border-b pb-4">
              ...
              <p className="font-light text-reg">Japonese</p>
            ...
            <div className="mt-3 pb-4">
              ...
              <div className="flex">
                ...
                <button className="border-r border-t border-b w-full text-reg font-light rounded-l p-2">
                  $$
                </button>
                <button className="border w-full text-reg font-light rounded-l p-2">
                  $$$
